...
export default function Home() {
  ...
  return (
    <div className="site-shell">
      <header className="topbar"><a className="brand" href="#top" aria-label="SANWA SERVICE GROUP・Duxy Video Catalog トップへ"><span className="brand-lockup"><span className="sanwa-logo-surface"><img className="sanwa-logo header-sanwa-logo" src="/manus-storage/sanwa-service-logo-highcontrast_8759e80b.png" alt="SANWA SERVICE" /></span><span className="brand-connector" aria-hidden="true"><i /><small>GROUP BRAND</small></span><span className="duxy-logo-surface"><img className="duxy-logo" src="/manus-storage/duxy-logo_0f2617a6.png" alt="Duxy" /></span></span><span className="brand-catalog-label">VIDEO CATALOG</span></a><nav className="main-nav" aria-label="ページ内ナビゲーション"><a href="#top">HOME</a><a href="#overview">CATEGORY</a><a href="#catalog">VIDEO CATALOG</a><a href="#shops">SHOPS</a></nav><a className="youtube-link" href="https://www.youtube.com/@duxy_aichi" target="_blank" rel="noreferrer"><Youtube size={17} fill="currentColor" /> <span>CHANNEL</span><ArrowUpRight size={13} /></a></header>
      <main id="top">
      ...
      <footer><div className="footer-brand"><img className="sanwa-logo footer-sanwa-logo" src="/manus-storage/sanwa-service-logo-highcontrast_8759e80b.png" alt="SANWA SERVICE" /><span className="footer-catalog-label">DUXY VIDEO CATALOG</span></div><p>分類基準：動画タイトルから読み取れる主目的。<br />各動画はYouTubeのDuxyチャンネルへ遷移します。</p><p className="footer-count">148 VIDEOS<br />8 CATEGORIES</p></footer>
    </div>
  );
}
