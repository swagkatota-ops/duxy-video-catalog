...
export default function Home() {
  ...
  return (
    <div className="site-shell">
      <header className="topbar"><a className="brand" href="#top" aria-label="SANWA SERVICE Duxy Video Catalog トップへ"><span className="sanwa-logo-surface"><img className="sanwa-logo header-sanwa-logo" src="/manus-storage/sanwa-service-logo_63f4f0a1.png" alt="SANWA SERVICE" /></span><span className="brand-catalog-label">DUXY VIDEO CATALOG</span></a><nav className="main-nav" aria-label="ページ内ナビゲーション"><a href="#top">HOME</a><a href="#overview">CATEGORY</a><a href="#catalog">VIDEO CATALOG</a><a href="#shops">SHOPS</a></nav><a className="youtube-link" href="https://www.youtube.com/@duxy_aichi" target="_blank" rel="noreferrer"><Youtube size={17} fill="currentColor" /> <span>CHANNEL</span><ArrowUpRight size={13} /></a></header>
      <main id="top">
      ...
      <footer><div className="footer-brand"><img className="sanwa-logo footer-sanwa-logo" src="/manus-storage/sanwa-service-logo-transparent_a21a98c0.png" alt="SANWA SERVICE" /><span className="footer-catalog-label">DUXY VIDEO CATALOG</span></div><p>分類基準：動画タイトルから読み取れる主目的。<br />各動画はYouTubeのDuxyチャンネルへ遷移します。</p><p className="footer-count">148 VIDEOS<br />8 CATEGORIES</p></footer>
    </div>
  );
}
