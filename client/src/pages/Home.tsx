...
function assetUrl(githubPath: string, manusPath: string) {
  return isGitHubPages ? `${import.meta.env.BASE_URL}assets/${githubPath}` : manusPath;
}
...
const shopList: Shop[] = [
  { name: "Duxy本店", area: "愛知県清須市", address: "〒452-0962 愛知県清須市春日砂賀東137番地", phone: "052-433-4911", tel: "0524334911", hours: "10:00–18:00", closed: "月曜・第2/第3火曜", url: "https://www.jcar.co.jp/shop/duxy-kitanagoya", mapUrl: "https://www.google.com/maps/search/?api=1&query=愛知県清須市春日砂賀東137", image: assetUrl("shops/main.jpg", "/manus-storage/main_cd39dc02.jpg"), video: { id: "LT2qyUtUJm8", title: "【店舗紹介】Duxy本店" } },
  { name: "Duxy名古屋東店", area: "愛知県春日井市", address: "〒486-0851 愛知県春日井市篠木町5-2475-6", phone: "0568-86-3477", tel: "0568863477", hours: "10:00–18:00", closed: "月曜・第2/第3火曜", url: "https://www.jcar.co.jp/shop/duxy-nagoyahigashi", mapUrl: "https://www.google.com/maps/search/?api=1&query=愛知県春日井市篠木町5-2475-6", image: assetUrl("shops/nagoya-east.jpg", "/manus-storage/nagoya-east_a8448b5c.jpg"), video: { id: "7TajlT7cmfU", title: "【店舗紹介】Duxy名古屋東店" } },
  { name: "Duxy名古屋西店", area: "愛知県津島市", address: "〒496-0005 愛知県津島市神守町一丁田53", phone: "0567-22-4711", tel: "0567224711", hours: "10:00–18:00", closed: "月曜・第2/第3火曜", url: "https://www.jcar.co.jp/shop/duxy-nagoyanishi", mapUrl: "https://www.google.com/maps/search/?api=1&query=愛知県津島市神守町一丁田53", image: assetUrl("shops/nagoya-west.jpg", "/manus-storage/nagoya-west_40a0bb9e.jpg"), video: { id: "aqBFKvFuKXY", title: "【店舗紹介】Duxy名古屋西店" } },
  { name: "Duxy豊田店", area: "愛知県みよし市", address: "〒470-0224 愛知県みよし市三好町森曽16-1", phone: "0561-33-2033", tel: "0561332033", hours: "10:00–18:00", closed: "月曜・第2/第3火曜", url: "https://www.jcar.co.jp/shop/duxy-miyoshi", mapUrl: "https://www.google.com/maps/search/?api=1&query=愛知県みよし市三好町森曽16-1", image: assetUrl("shops/toyota.jpg", "/manus-storage/toyota_f20e7bc6.jpg") },
  { name: "Duxy安城店", area: "愛知県安城市", address: "〒446-0053 愛知県安城市高棚町小牧30", phone: "0566-92-5615", tel: "0566925615", hours: "10:00–18:00", closed: "月曜・第2/第3火曜", url: "https://www.jcar.co.jp/shop/duxy-anjo", mapUrl: "https://www.google.com/maps/search/?api=1&query=愛知県安城市高棚町小牧30", image: assetUrl("shops/anjo.jpg", "/manus-storage/anjo_c5ca574c.jpg") },
  { name: "Duxy大垣店", area: "岐阜県大垣市", address: "〒503-0804 岐阜県大垣市中ノ江1丁目28番1", phone: "0584-74-1881", tel: "0584741881", hours: "10:00–18:00", closed: "月曜・第2/第3火曜", url: "https://www.jcar.co.jp/shop/duxy-ohgaki", mapUrl: "https://www.google.com/maps/search/?api=1&query=岐阜県大垣市中ノ江1丁目28-1", image: assetUrl("shops/ogaki.jpg", "/manus-storage/ogaki_144f4b4b.jpg") },
  { name: "Duxy可児店", area: "岐阜県可児市", address: "〒509-0203 岐阜県可児市下恵土字広瀬5864-1", phone: "0574-61-3333", tel: "0574613333", hours: "10:00–18:00", closed: "月曜・第2/第3火曜", url: "https://www.jcar.co.jp/shop/duxy-kani", mapUrl: "https://www.google.com/maps/search/?api=1&query=岐阜県可児市下恵土5864-1", image: assetUrl("shops/kani.jpg", "/manus-storage/kani_1cefb7a3.jpg"), video: { id: "BV9ujwRPN-M", title: "【店舗紹介】Duxy可児店" } },
  { name: "Duxy北名古屋店", area: "愛知県清須市", address: "〒452-0962 愛知県清須市春日新町39-1", phone: "052-408-5855", tel: "0524085855", hours: "10:00–18:00", closed: "月曜・第2/第3火曜", url: "https://www.jcar.co.jp/shop/j-auto-international-kitanagoya", mapUrl: "https://www.google.com/maps/search/?api=1&query=愛知県清須市春日新町39-1", image: assetUrl("shops/kita-nagoya.jpg", "/manus-storage/kita-nagoya_72bb132f.jpg"), video: { id: "VwlfLQ-JWEM", title: "【店舗紹介】Duxy北名古屋店" } },
  { name: "Duxy清須店", area: "愛知県清須市", address: "〒452-0941 愛知県清須市西市場5丁目5-3", phone: "052-400-0855", tel: "0524000855", hours: "10:00–18:00", closed: "月曜・第2/第3火曜", url: "https://www.jcar.co.jp/shop/duxy-kiyosu", mapUrl: "https://www.google.com/maps/search/?api=1&query=愛知県清須市西市場5丁目5-3", image: assetUrl("shops/kiyosu.jpg", "/manus-storage/kiyosu_cd38bddd.jpg") },
  { name: "Duxy天白店", area: "愛知県名古屋市", address: "〒468-0013 愛知県名古屋市天白区荒池2-1304", phone: "052-807-5678", tel: "0528075678", hours: "10:00–18:00", closed: "月曜・第2/第3火曜", url: "https://www.jcar.co.jp/shop/duxy-tenpaku", mapUrl: "https://www.google.com/maps/search/?api=1&query=愛知県名古屋市天白区荒池2-1304", image: assetUrl("shops/tenpaku.jpg", "/manus-storage/tenpaku_536e64d2.jpg"), video: { id: "5yCT9bkyTFk", title: "【祝1周年】Duxy天白店のご紹介" } },
  { name: "Duxy岡崎店", area: "愛知県岡崎市", address: "〒444-0858 愛知県岡崎市上六名4丁目1-1", phone: "0564-73-0771", tel: "0564730771", hours: "10:00–18:00", closed: "月曜・第2/第3火曜", url: "https://www.jcar.co.jp/shop/duxy-okazaki", mapUrl: "https://www.google.com/maps/search/?api=1&query=愛知県岡崎市上六名4丁目1-1", image: assetUrl("shops/okazaki.jpg", "/manus-storage/okazaki_4940891c.jpg"), video: { id: "h69RaRaSFRQ", title: "【店舗紹介】Duxy岡崎店" } },
];
...
export default function Home() {
  ...
  return (
    <div className="site-shell">
      <header className="topbar"><a className="brand" href="#top" aria-label="SANWA SERVICE GROUP・Duxy Video Catalog トップへ"><span className="brand-lockup"><span className="sanwa-logo-surface"><img className="sanwa-logo header-sanwa-logo" src={catalogAssets.sanwaLogo} alt="SANWA SERVICE" /></span><span className="brand-connector" aria-hidden="true"><i /><small>GROUP BRAND</small></span><span className="duxy-logo-surface"><img className="duxy-logo" src={catalogAssets.duxyLogo} alt="Duxy" /></span></span><span className="brand-catalog-label">VIDEO CATALOG</span></a><nav className="main-nav" aria-label="ページ内ナビゲーション"><a href="#top">HOME</a><a href="#overview">CATEGORY</a><a href="#catalog">VIDEO CATALOG</a><a href="#shops">SHOPS</a></nav><a className="youtube-link" href="https://www.youtube.com/@duxy_aichi" target="_blank" rel="noreferrer"><Youtube size={17} fill="currentColor" /> <span>CHANNEL</span><ArrowUpRight size={13} /></a></header>
      <main id="top">
        <section className="hero"><img className="hero-art" src={catalogAssets.hero} alt="" /><div className="hero-noise" /><div className="hero-content"><p className="eyebrow"><span className="eyebrow-line" /> DUXY CHANNEL ARCHIVE</p><h1>クルマ選びを、<br /><em>もっと確かに。</em></h1><p className="hero-copy">Duxyチャンネルの148本を、検討テーマごとに再編集。<br className="desktop-break" />知りたい動画へ、最短でたどり着けるカタログです。</p><a className="hero-cta" href="#catalog">動画を探す <ChevronDown size={18} /></a></div><div className="hero-meta"><span>CURATED</span><strong>148</strong><span>VIDEOS / 8 CATEGORIES</span></div><div className="hero-bottom-line" /></section>
      ...
      <footer><div className="footer-brand"><img className="sanwa-logo footer-sanwa-logo" src={catalogAssets.sanwaLogo} alt="SANWA SERVICE" /><span className="footer-catalog-label">DUXY VIDEO CATALOG</span></div><p>分類基準：動画タイトルから読み取れる主目的。<br />各動画はYouTubeのDuxyチャンネルへ遷移します。</p><p className="footer-count">148 VIDEOS<br />8 CATEGORIES</p></footer>
    </div>
  );
}
