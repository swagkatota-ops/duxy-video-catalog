...
export default function Home() {
  ...
  return (
    <div className="site-shell">
      <header className="topbar"><a className="brand" href="#top" aria-label="SANWA SERVICE Duxy Video Catalog トップへ"><span className="sanwa-logo-surface"><img className="sanwa-logo header-sanwa-logo" src="/manus-storage/sanwa-service-logo-highcontrast_8759e80b.png" alt="SANWA SERVICE" /></span><span className="brand-catalog-label">DUXY VIDEO CATALOG</span></a><nav className="main-nav" aria-label="ページ内ナビゲーション"><a href="#top">HOME</a><a href="#overview">CATEGORY</a><a href="#catalog">VIDEO CATALOG</a><a href="#shops">SHOPS</a></nav><a className="youtube-link" href="https://www.youtube.com/@duxy_aichi" target="_blank" rel="noreferrer"><Youtube size={17} fill="currentColor" /> <span>CHANNEL</span><ArrowUpRight size={13} /></a></header>
      <main id="top">
